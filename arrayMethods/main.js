...
// EX1
// console.log(users.map( u => ({name: u.name, comapnyName: u.company.name})))


// EX2 + 3
// let newUsers = users.filter( u => u.address.zipcode[0] === '5' ).map( u => u.id )
// console.log(newUsers)


// EX4
// let cNames = users.filter( u => u.name[0].toLowerCase() === 'c').map( u => u.name)
// console.log(cNames)
